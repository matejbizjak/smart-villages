...
public class EnergySolarIntervalForSolar {
    ...
    public EnergySolarIntervalForSolar() {
    }

    public EnergySolarIntervalForSolar(SolarEntity solar, Instant startTime, Instant endTime, BigDecimal sum, List<EnergyEntity> energyList) {
        this.solar = solar;
